 ...
 */
public class DeleteEntityException  extends AbstractException {
    ...
    public DeleteEntityException() {
        super(ExceptionEnum.DELETE_EXCEPTION);
    }
     ...
     * @param exceptionEnum
     */
    public DeleteEntityException(ExceptionEnum exceptionEnum) {
        super(exceptionEnum);
    }
